...
namespace StoreOperation.WebApi.Migrations
{
    ...
    [Migration("20210918092655_initialize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.AppLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.AppStore", b =>
                {
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.AppUserAppStore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckList", b =>
                {
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckListDay", b =>
                {
                    b.Property<Guid>("CheckListDayId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckListQuestion", b =>
                {
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckListQuestionGroup", b =>
                {
                    b.Property<Guid>("CheckListQuestionGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppRoleAppUser", b =>
                {
                    b.HasOne("StoreOperation.WebApi.Entities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RolesRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoreOperation.WebApi.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.AppUserAppStore", b =>
                {
                    b.HasOne("StoreOperation.WebApi.Entities.AppStore", "Store")
                        .WithMany("RelationShopeStoreUser")
                        .HasForeignKey("StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoreOperation.WebApi.Entities.AppUser", "User")
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckList", b =>
                {
                    b.HasOne("StoreOperation.WebApi.Entities.AppUser", "Certifying")
                        .WithMany()
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoreOperation.WebApi.Entities.CheckListDay", "CheckListDay")
                        .WithMany("CheckLists")
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckListQuestion", b =>
                {
                    b.HasOne("StoreOperation.WebApi.Entities.CheckListQuestionGroup", "Group")
            ...
            modelBuilder.Entity("StoreOperation.WebApi.Entities.CheckListQuestionGroup", b =>
                {
                    b.HasOne("StoreOperation.WebApi.Entities.CheckList", null)
