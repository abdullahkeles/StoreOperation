...
namespace StoreOperation.WebApi.Configuration.Context
{
    public class StoreOperationConfigurationContext : IStoreOperationConfigurationContext
    {
        public StoreOperationConfigurationContext(IEnvironmentService environmentService)
        {
            ...
            ProfileImageMaxFileLength =
                int.Parse(environmentService.Configuration["General:ProfileImageMaxFileLength"]);

            UpdatePasswordWebPageUrl = environmentService.Configuration["General:UpdatePasswordWebPageUrl"];

            SecurityKeyExpiryFromHours =
                int.Parse(environmentService.Configuration["General:SecurityKeyExpiryFromHours"]);
        }
